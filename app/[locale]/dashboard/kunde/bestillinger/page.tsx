...
export async function generateMetadata({
  ...
  return {
    title: t('buyerBookingsTitle'),
    description: t('buyerBookingsDescription'),
  }
}

export default async function DashboardKundeBestillingerPage() {
  ...
  const buyerRows = await fetchBuyerBookings(supabase, ctx.profileId)
  ...
  return (
    <div className="space-y-6">
      ...
      <BookingsTable rows={buyerRows} variant="buyer" />
    </div>
  )
}
