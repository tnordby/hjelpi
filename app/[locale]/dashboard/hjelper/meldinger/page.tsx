...
export async function generateMetadata({
  ...
  return {
    title: t('sellerMessagesTitle'),
    description: t('messagesDescription'),
  }
}

export default async function DashboardHjelperMeldingerPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <DashboardMessagesPanel threads={threads} bookingsLinkHref="/dashboard/hjelper/foresporsler" />
    </div>
  )
}
